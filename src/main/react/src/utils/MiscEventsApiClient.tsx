...
const internalizeEvent: (externalEvent: MiscellaneousEventResponse) => MiscEvent = (externalEvent:MiscellaneousEventResponse) => ({
  ...externalEvent,
...
const createEvent = (props:{ location: string, comment?:string, title:string, startTime: Date, userIds:number[] }) => {
...
const updateEvent = (props:{ id:number, location?:string, title?:string, comment?:string, startTime?:Date }) => {
  return eventsClient.callWithBody(
