...
sealed class CouldNotCreateEntityException(override val message: String?, override val cause: Throwable? = null) :
    RuntimeException() {
    class UserCreationException(message: String?, cause: Throwable? = null) :
